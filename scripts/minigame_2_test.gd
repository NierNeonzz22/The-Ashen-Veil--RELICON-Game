...
var total_placements := 100  # Total number of slots that need to be filled correctly
...
func _on_reset_pressed():
	...
	print("✔ Reset completed. correct_placements =", correct_placements)
...
func check_win_condition():
	if correct_placements == 7 and not game_ended:  # ADDED: Check game_ended flag
